...
void UpdateGirl(void)
{
	...
	for (int nCntGirl = 0; nCntGirl < MAX_GIRL; nCntGirl++)
	{
		...
		if (g_aGirl[nCntGirl].aState == GIRL_STATE_RIGHT)
		{
			g_aGirl[nCntGirl].move.x = 1.0f;
		}
		else if (g_aGirl[nCntGirl].aState == GIRL_STATE_LEFT)
		{
			g_aGirl[nCntGirl].move.x = -1.0f;
		}
		else if (g_aGirl[nCntGirl].aState == GIRL_STATE_NONE)
		{
			g_aGirl[nCntGirl].move.x = 0.0f;
		}

		//移動量の加算
		g_aGirl[nCntGirl].pos += g_aGirl[nCntGirl].move;
