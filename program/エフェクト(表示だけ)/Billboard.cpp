...
HRESULT InitBillboard(void)
{
	...
	{
		//頂点の座標
		pVtx[0].pos = D3DXVECTOR3(g_Billboard[nCntBillboard].pos.x - (g_Billboard[nCntBillboard].fWhidth / 2), g_Billboard[nCntBillboard].pos.y + (g_Billboard[nCntBillboard].fHight), 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_Billboard[nCntBillboard].pos.x + (g_Billboard[nCntBillboard].fWhidth / 2), g_Billboard[nCntBillboard].pos.y + (g_Billboard[nCntBillboard].fHight), 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_Billboard[nCntBillboard].pos.x - (g_Billboard[nCntBillboard].fWhidth / 2), g_Billboard[nCntBillboard].pos.y, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_Billboard[nCntBillboard].pos.x + (g_Billboard[nCntBillboard].fWhidth / 2), g_Billboard[nCntBillboard].pos.y, 0.0f);
