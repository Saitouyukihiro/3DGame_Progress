...
HRESULT InitPicture(void)
{
	...
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(	pDevice,
								"data/Texture/Unlimited mode.png",				//テクスチャ
	...
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(	pDevice,
								"data/Texture/wall_001.jpg",				//テクスチャ
								&g_pTexturePicture[PICTURE_SELECT]);
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(	pDevice,
								"data/Texture/operation.png",				//テクスチャ
								&g_pTexturePicture[PICTURE_OPERATE]);
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(	pDevice,
								"data/Texture/Title.png",				//テクスチャ
								&g_pTexturePicture[PICTURE_TITLENAME]);
